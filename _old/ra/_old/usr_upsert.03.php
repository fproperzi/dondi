...
if(!empty($_REQUEST['action'])) {
   ...
   $message = "Done!";
    ...
    try {
        ...
        break; case '_list_banned':   if(empty($bBanned)) $bBanned = 2;     // list deleted (only for admin)
               case '_list_pending':  if(empty($bBanned)) $bBanned = 1;     // list only approved
...
$(document).on("pagecreate", "#page-lg-list", function() {
    ...
    $('.p-lg-pending' ).on('click',function(){ vfActionLoad( {action:'_list_pending' } ,vfActionSwitch); });
            ...
            <div data-role="footer" data-position="fixed" data-tap-toggle="false">
                <div data-role="navbar">
                    <ul>
                        ...
                        <li><a href="#" data-icon="forbidden" class="p-lg-pending">Pending</a></li>
                        <li><a href="#" data-icon="skull"     class="p-lg-banned">Banned</a></li>
                    </ul>
                </div>
            </div>
        </div> <!-- //page-lg-list -->
