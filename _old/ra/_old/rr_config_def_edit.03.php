...
//rr_config_def setted but you are not admin
...
$ga_config = array( 
	...
	),"C_CONFIG_DB_CHARSET"    => array("a"=>  _U    ,"l"=>"DB CharSet"	          ,"t"=>"text" 	   ,"p"=>"DataBase Charset"                            ,"d"=>"utf8"                       ,"filter"=>FILTER_VALIDATE_REGEXP        ,"flags"=>FILTER_REQUIRE_SCALAR ,"options"=>array("regexp"=>C_REGEXP_ASCII)                  ,"h"=>"valid charset"																                                        
