...
function vfActionLoad(o,vfCallBack) {
    o = _.extend(o || {},{'ajax':'on'}); // is ajax call please give/respond json
    $.ajax({
...
(function($,window,document,undefined) {
    ...
    var defaults = {
         k2t: "data-i18n"         //key to text   data-i18n="tons"   -> "get %s tons of tomato"
...
(function($,window,document,undefined) {
    ...
    var I18n = {  // i18n property list

        dict: {},  // load from javascript source
        /**
