...
//                $this.each( applyContext ) : 
//                $this.find( "[data-i18n]" ).each( applyContext );
//        });
//        
//    };
//
...
/** from boilerplates: https://gist.github.com/addyosmani/1184226
*/
//(function($,window,document,undefined) {
//
...
//        
//        var q = new RegExp('[\?&]l=([^&#]*)','i').exec( $('script[src*=rr]').attr('src') );
//        if(q) $.getJSON(q[1],function(j) {
//            this.options.dict = $.extend({}, j );
//        });
//        
//    };
//
...
//        return this.each(function () {
//            if (!$.data(this, "plugin")) {
//                $.data(this, "plugin", new I18n(this, options));
//            }
//        });
//    }
//    
...
(function($,window,document,undefined) {
    ...
    var k2t = "data-i18n",       //key to text   data-i18n="tons"   -> "get %s tons of tomato"
        ...
        dict = {}, I18n = {      // i18n property list

        loadLang : function() {
            var q = new RegExp('[\?&]l=([^&#]*)','i').exec( $('script[src*=rr]').attr('src') );  // get from url: "js/rr.js?l=en.json"
            if(q) $.ajax({
                    url: q[1] + "?_=" + new Date().getTime(),
                    async: false,  //cant use getjson for that....
                    dataType: "json",
                    scriptCharset: "utf-8",
                    ...
                    error: function(){
                        var j = "http://jsonlint.com?json="+ location.href.substring(0, location.href.lastIndexOf('/')+1)+q[1];
                        $.error(q[1] + " is not a valid json file check-it here: "+ j);
                    }
                });
        },
    ...
    */
    ...
    /*
    $.getJSON("i18n/en.json",function(j) {
        i18n.dict = $.extend({}, j );
    });
    */
