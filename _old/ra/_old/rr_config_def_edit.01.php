...
$ga_config = array( /** _L+_O+_2I+_2U+_2D+_2C+_I+_U+_D+_C ** required field for action **/
	  "check_dir"              => array("a"=>_N      ,"l"=>"check file, directory permission" ,"t"=>"checklist","p"=>""                                            ,"d"=>""         ,"o"=>aoDefCheck(),"filter"=>FILTER_CALLBACK               ,"flags"=>FILTER_REQUIRE_ARRAY  ,"options"=>function($v){return bfInArray($v,aodefCheck());} ,"h"=>"Pass check about host"																                                        
