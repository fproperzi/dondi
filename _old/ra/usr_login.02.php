   ...
   <div data-role="content" >   
 		<form id="form-usr-signin" method="post"><input type="hidden" name="action" value="signin"/>
			<div class="ui-field-contain">
               <label><span data-i18n="user-name-email">Username or Email</span>                  <!--tooltip-btn ui-btn ui-alt-icon ui-nodisc-icon ui-btn-inline ui-icon-info ui-btn-icon-notext-->
                <a href="#pop-help-user-name-email" data-rel="popup" data-transition="pop" class="tooltip-btn ui-btn ui-btn-b ui-nodisc-icon ui-corner-all ui-icon-info ui-btn-icon-notext ui-btn-inline" data-i18n="_help">Help</a>
                <div data-role="popup" id="pop-help-user-name-email" class="ui-content" data-theme="a" data-arrow="true" style="max-width:350px;" data-i18n="user-name-email-help">
                  Insert here your user-name or your email
                </div>          
                </label>
			...
			<div class="ui-field-contain">	
                ...
                <a href="#pop-help-remember" data-rel="popup" data-transition="pop" class="tooltip-btn ui-btn ui-btn-b ui-nodisc-icon ui-corner-all ui-icon-info ui-btn-icon-notext ui-btn-inline" data-i18n="_help">Help</a>
                <div data-role="popup" id="pop-help-remember" class="ui-content" data-theme="a" data-arrow="true" style="max-width:350px;" data-i18n="remember-help"> 
                  Do you want the application reconize you on this computer?  
                </div>          
                </label>
                
				<select id="user_remember" name="user_remember" data-role="slider">
					<option value="0" data-i18n="_no">No</option>
					<option value="1" data-i18n="_yes">Yes</option>
				</select>          
			</div>
			<div class="ui-field-contain">	
				<label></label>
				<input id="do-signin" type="submit" data-i18n="_submit" value="Submit" data-role="button" data-inline="true" data-icon="check" data-theme="b" />
...
<div id="page-usr-forgot" data-role="page" data-theme="b">
    <div data-role="header">
		<a href="#page-usr-sign-in" data-rel="back" class="ui-btn ui-corner-all ui-icon-back ui-btn-icon-left" data-i18n="_back">Back</a>
    ...
    <div role="main" class="ui-content">
		...
		<form id="form-user-forgot" method="post"><input type="hidden" name="action" value="forgot"/>
			...
			<div class="ui-field-contain">	
				<label></label>
				<input type="submit" data-i18n="_submit" value="Submit" data-role="button" data-inline="true" data-icon="search" />
			</div>
...
<!--@@@--><a href="#pop-usr-forgot" data-rel="popup" data-transition="pop" data-position-to="window" data-inline="true" class="ui-btn ui-btn-b ui-corner-all">pop</a>           
            ...
            <div data-role="popup" id="pop-usr-forgot" data-dismissible="false" style="max-width:400px;" data-theme="a">
                ...
                <div role="main" class="ui-content">
                    ...
                    <a href="#page-usr-reset" class="ui-btn ui-corner-all ui-shadow ui-btn-b" data-i18n="_ok">OK</a>
                </div>
            </div>
		</form>
    </div><!-- /content --> 
...
<div id="page-usr-reset" data-role="page" data-theme="b">
    <div data-role="header">
		<a href="#page-usr-pwd-forgot" data-rel="back" class="ui-btn ui-corner-all ui-icon-back ui-btn-icon-left" data-i18n="_back">Back</a>
    ...
    <div role="main" class="ui-content">
		<form id="form-usr-reset" method="post"><input type="hidden" name="action" value="reset"/>
			...
			<div class="ui-field-contain">
				<label></label>
				<input type="submit" data-i18n="_reset" value="Reset" data-role="button" data-inline="true" data-icon="recycle" />
			</div>
...
<div id="page-usr-signup" data-role="page" data-theme="b">
    ...
    <div role="main" class="ui-content">
		<form id="form-usr-signup" method="post"><input type="hidden" name="action" value="signup"/>
            ...
            <div class="ui-field-contain">
            	<label></label>
				<input type="submit" data-i18n="_submit" value="Submit" data-role="button" data-inline="true" data-icon="edit" />
			</div>
		</form>
...
<div id="page-usr-profile" data-role="page" data-theme="b">
   ...
   <div role="main" class="ui-content">
      ...
      <form id="form-usr-profile" method="post"><input type="hidden" name="action" value="profile"/>
        ...
        <div data-role="fieldcontain">
            <label></label>
            <input type="submit" name="doProfile" data-i18n="_save" value="Save" data-role="button" data-inline="true"/>  
            <a href="index.php" data-role="button" data-inline="true" data-i18n="_cancel">Cancel</a>	
        </div>
...
<div id="page-usr-locked" data-role="page" data-theme="b">
    <div data-role="header">
		<a href="#" data-rel="back" class="ui-btn ui-corner-all ui-icon-back ui-btn-icon-left" data-i18n="_back">Back</a>
        <h1 data-i18n="locked">Locked!</h1>
    </div><!-- /header -->
    <div role="main" class="ui-content">
        <div class="ui-body-b ui-corner-all">
            <h3 class="text-red" data-i18n="account-locked">Your Account is Locked</h3>
            <p data-i18n="account-locked-help">Please contact the Administrator to resolve this issue.</p>
            <a href="mailto:<?= C_CONFIG_ADMIN_EMAIL ?>"class="ui-btn ui-corner-all ui-icon-mail ui-btn-icon-left ui-btn-inline" data-i18n="_administrator">Admin</a>
        </div>
    </div><!-- /content --> 
</div><!-- /page -->	
...
<div id="page-usr-confirm" data-role="page" data-theme="b">
    ...
    <div role="main" class="ui-content">
        ...
        <a href="#page-usr-signin" class="ui-btn ui-corner-all ui-icon-user ui-btn-icon-left ui-btn-inline" data-i18n="signin">Sign-in</a>
    </div><!-- /content --> 
</div><!-- /page -->	
			
<div id="page-usr-landing" data-role="page" data-theme="b">
    <div data-role="header">
        <h1 data-i18n="_welcome">Welcome!</h1>
    </div><!-- /header -->
    <div role="main" class="ui-content">
        <ul data-role="listview" data-inset="true">
            <h3 style="text-align:ceter">Rugby Assistant & Repository</h3>
            <img src="img/rr.png" title="logo">
            ...
            <li data-role="list-divider" data-i18n="useful-links">Useful links</li>
            <li><a href="http://www.rugbyassistant.org">Rugby assistant & repository</a></li>
            <li><a href="http://www.github.com/fproperzi/rugbyassistant">on GitHub</a></li>
        </ul>
    </div><!-- /content -->
</div><!-- /page -->		
